...
<body>
        ...
        <div>
             ...
             <asp:GridView ID="dgvPersonas" runat="server" 
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="strNumHermanos" HeaderText="Hermanos" 
                        SortExpression="strNumHermanos" />
    ...
    <asp:LinqDataSource ID="DataSourcePersona" runat="server" 
        ...
        Select="new (strNombre, strAPaterno, strAMaterno, CatSexo, dteFechaNacimiento , strNumHermanos,strClaveUnica,id)" 
